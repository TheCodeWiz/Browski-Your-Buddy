...
const LinkedInIcon = () => {
  ...
  return (
    <div className="icon cursor-default mt-5 text-3xl flex gap-5">
      <div className="-mt-6 font-semibold bg-gradient-to-l from-slate-700 via-slate-400 to-slate-100 bg-clip-text text-transparent">
      ...
      <div
        ...
        tabIndex={0}
        onKeyPress={(e) => {
          if (e.key === "Enter") handleLinkedInRedirect();
        }}
      >
        <FaUser />
      </div>
